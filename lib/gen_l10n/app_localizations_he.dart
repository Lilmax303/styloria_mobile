...
class AppLocalizationsHe extends AppLocalizations {
  ...
  @override
  String get myCustomerRating => 'דירוג הלקוח שלי';
  ...
  String reviewsFromProviders(int count) {
    ...
    return '$count $_temp0 מספקי שירות';
  }

  @override
  String get failedToLoadReputation => 'טעינת נתוני המוניטין נכשלה';
  ...
  String weDetectedYoureIn(String country) {
    return '📍 זיהינו שאתה נמצא ב$country. אנא בחר את המדינה שלך למטה.';
  }

  @override
  String get locationMarkedAsOther =>
      'המיקום סומן כ\"אחר\" - תוכל להמשיך בהרשמה';
